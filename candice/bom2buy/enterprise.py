...
# driver.find_element_by_css_selector(".ant-btn antd-pro-components-login-index-submit antd-pro-pages-user-login"
#                                    "-submitButton ant-btn-primary ant-btn-lg").click()
# driver.find_element_by_class_name("ant-btn antd-pro-components-login-index-submit antd-pro-pages-user-login-submitButton ant-btn-primary ant-btn-lg")
