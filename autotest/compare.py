...
def read_excel():
    wb_pri = xlrd.open_workbook('/Users/Zhangjiahui/PycharmProjects/autotest/venv/file/verp.xlsx')  # 打开原始文件
    wb_tar = xlrd.open_workbook('/Users/Zhangjiahui/PycharmProjects/autotest/venv/file/vert.xlsx')  # 打开目标文件
